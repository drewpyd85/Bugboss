...
<div class="container pt-5 intro-section">
    ...
    <div class="row text-center">
        ...
        <div class="col-md-5 hidden-md-down pest-man-container">
            
            <div class="pest-man"></div>
        ...
        <div class="col-md-7">
            ...
            <div class="row">
                <div class="col">
                    <p>We honor those who serve so as a special "thanks" we give 10% off all services to the brave men and women in our community.</p>
                </div>
            </div>
